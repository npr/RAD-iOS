//
//  RadMetadata+CoreDataProperties.swift
//  RADTestApplication
//
//  Copyright 2018 NPR
//
...
extension RadMetadata {
    @nonobjc class func fetchRequest() -> NSFetchRequest<RadMetadata> {
        return NSFetchRequest<RadMetadata>(entityName: "RadMetadata")
    }
...
extension RadMetadata {
    ...
    @NSManaged func removeFromMetadataRelations(
        _ value: MetadataRelation)
